...
if (!isset($_GET['id']) or !isset($posts[$_GET['id']])){
    header('Location: '. WEB_URL .'index.php?a=404');
    die;
}
$post = $posts[$_GET['id']];
?>
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            <div class="blog-post">
                ...
                <p class="blog-post-meta"><?= $post['data']; ?>
                    <a href="#"><?= $post['autor']; ?></a></p>
                <?= $post['content']; ?>
